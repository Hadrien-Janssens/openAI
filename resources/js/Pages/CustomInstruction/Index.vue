...
<template>
    ...
    <div class="w-full px-10 pb-0">
        <div>
            ...
            <h4 class="mb-2 text-sm">
                Cette section est votre espace pour informer l'assistant sur qui
                vous êtes, vos intérêts, et votre domaine d'expertise. Cette
                information aide l'assistant à adapter ses réponses et
    ...
    <div class="w-full p-10 pb-0">
        <div>
            <h3 class="mb-2 text-lg font-bold">Comportement de l'assistant</h3>
            <h4 class="mb-2 text-sm">
                Ici, vous avez la possibilité de définir comment vous souhaitez
                que l'assistant interagisse avec vous. Cela comprend le ton des
                réponses, leur format, et même la manière dont les concepts sont
                expliqués.
            </h4>
        </div>
    ...
    <div class="w-full p-10 pb-0">
        ...
        <form action="">
            <textarea name="" id="" rows="10" class="w-full border"></textarea>
